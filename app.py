...
restaurantes = [{'nome':'Mr.Lee', 'categoria': 'Comida Japonesa','ativo':False},
                {'nome':'Pizzaria da Mama','categoria':'Pizza', 'ativo':True},
                {'nome':'Cantina','categoria':'Lanches e Salgados', 'ativo':False}]
